...
| Alan | App Store (iOS) | Google Play |
|---|---|---|
| Başlık / App adı | 30 karakter | 30 karakter |
| Alt başlık (subtitle) | 30 karakter | — (yok) |
| Anahtar kelime alanı | 100 karakter (virgülle, boşluksuz) | — (yok; açıklamadan taranır) |
| Kısa açıklama | — (promo metni 170) | 80 karakter |
| Açıklama | 4.000 karakter | 4.000 karakter |

> Play'de ayrı anahtar kelime/alt başlık alanı yok; anahtar kelimeleri kısa ve uzun açıklamaya **doğal** biçimde yedir.

---

## Anahtar kelime araştırması (tohum listeler)

Aşağıdakiler konumlandırmadan türetilmiş tohum kelimelerdir; yayından sonra PostHog + App Store/Play arama verisiyle (madde 1) daraltılmalı. Hacim/rekabet için AppTweak, App Radar veya Sensor Tower gibi bir ASO aracında doğrula.

- **TR:** kişisel gelişim, kitap özeti, günlük motivasyon, ilham, bilgelik, alışkanlık, mikro öğrenme, farkındalık, üretkenlik, stoacılık, felsefe, günlük alıntı
- **EN:** personal growth, book summaries, daily motivation, wisdom, mindset, habits, micro learning, self improvement, productivity, stoicism, philosophy, daily quote
- **ES:** desarrollo personal, resúmenes de libros, motivación diaria, sabiduría, hábitos, microaprendizaje, superación, productividad, estoicismo, frases diarias
- **DE:** persönliche entwicklung, buchzusammenfassung, motivation, weisheit, gewohnheiten, mikrolernen, selbstverbesserung, produktivität, stoizismus, achtsamkeit
...
`kişisel gelişim,kitap özeti,motivasyon,ilham,bilgelik,alışkanlık,farkındalık,üretkenlik,stoa,alıntı`
...
• Yüzlerce hikâye: Kişisel gelişim, felsefe, alışkanlıklar ve daha fazlası
• Sohbette Kullan: Fikri gerçek konuşmalara taşıyacak hazır cümleler
• Sesli dinleme: Yürürken, işe giderken kulağına
...
**Keywords (iOS, ~100):**
`growth,book summary,motivation,wisdom,mindset,habits,self help,productivity,stoicism,quote`

**Description (iOS & Play):**
```
...
• Hundreds of stories: growth, philosophy, habits and more
• Use in Conversation: ready-made lines to bring ideas into real talks
• Listen on the go: audio for your walk or commute
...
`desarrollo personal,resumen libros,motivación,sabiduría,hábitos,superación,productividad,frases`

**Descripción (iOS & Play):**
```
...
• Cientos de historias: crecimiento, filosofía, hábitos y más
• Usar en conversación: frases listas para llevar las ideas a charlas reales
• Escucha donde sea: audio para caminar o ir al trabajo
...
**Keywords (iOS, ~100):**
`entwicklung,buchzusammenfassung,motivation,weisheit,gewohnheiten,produktivität,stoizismus,zitat`

**Beschreibung (iOS & Play):**
```
...
• Hunderte Geschichten: Entwicklung, Philosophie, Gewohnheiten und mehr
• Im Gespräch nutzen: fertige Sätze, um Ideen in echte Gespräche zu bringen
• Unterwegs hören: Audio für Spaziergang oder Arbeitsweg
...
1. App Store Connect ve Play Console'a yukarıdaki metinleri gir (her dil için ayrı yerelleştirme).
2. Her dil için ekran görüntüsü seti hazırla; ilk 2 görselde değer önerisini ve "Sohbette Kullan" / "Günün Kıvılcımı" ekranlarını öne çıkar.
3. Yayından 2–4 hafta sonra PostHog + mağaza arama verisiyle anahtar kelimeleri revize et (madde 1 ile bağlantılı).
4. A/B: iOS'ta alt başlık ve Play'de kısa açıklama varyantlarını test et.

## Kaynaklar (alan limitleri)

- [Creating Your Product Page — Apple Developer](https://developer.apple.com/app-store/product-page/)
- [App Store Metadata for Indie Devs — AppScreenshotStudio](https://appscreenshotstudio.com/blog/app-store-metadata-for-indie-devs-title-subtitle-keywords-2026)
