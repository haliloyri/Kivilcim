...
const ANALYTICS_EVENTS = {
  ...
  CAREER_PATH_EXPOSURE: 'career_path_exposure',
  CAREER_PATH_VIEWED: 'career_path_viewed',
  CAREER_PATH_INTRO_VIEWED: 'career_path_intro_viewed',
  CAREER_PATH_FOCUS_CHANGED: 'career_path_focus_changed',
  CAREER_NODE_OPENED: 'career_node_opened',
  CAREER_NEXT_ACTION_CLICKED: 'career_next_action_clicked',
  CAREER_NODE_COMPLETED: 'career_node_completed',
  CAREER_PROMOTION_SEEN: 'career_promotion_seen',
  CAREER_PROMOTION_DISMISSED: 'career_promotion_dismissed',
  CAREER_PROMOTION_SHARED: 'career_promotion_shared',
