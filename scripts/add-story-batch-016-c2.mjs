...
import { book, stories } from './batch-016-data.mjs';
...
const paths = {
  ...
  batch: resolve(root, 'HIKAYE_URETIM_BATCH_016.md'),
};
...
if (catalog.includes(rowBefore)) {
  ...
  catalog = catalog.replace(
    ...
    'uygulama veritabanındaki 276 kitabı ve içerik üretimi için seçilen 24 yeni kitabı');
